...
(function(global) {
  ...
  fabric.Beacon.fromElement = function(element, options) {
    var beacon, parsedAttributes;
    if (!element) {
      return null;
    }
    parsedAttributes = fabric.parseAttributes(element, fabric.Beacon.ATTRIBUTE_NAMES);
    parsedAttributes = _setDefaultLeftTopValues(parsedAttributes);
    beacon = new fabric.Beacon(extend((options ? fabric.util.object.clone(options) : {}), parsedAttributes));
