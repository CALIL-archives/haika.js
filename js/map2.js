...
var EPSG3857_geojson, center, coordinate, coordinates, data, features, geojson, geometry, image, log, map, map_center, new_geojson, object, styleFunction, styles, vectorLayer, vectorSource, x, y, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
...
if (geojson && new_geojson.features.length > 0) {
  _ref2 = new_geojson.features;
  for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
    object = _ref2[_k];
    log(object);
    coordinates = [];
    _ref3 = object.geometry.coordinates[0];
