...
haika = {
  ...
  render: function() {
    ...
    if (this.background_image) {
      ...
      this.background_image._originalElement.height = Math.floor(this.background_image.height * this.options.bgscale * this.scale);
