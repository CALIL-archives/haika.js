...
haika = {
  ...
  render: function() {
    ...
    if (this.background_image) {
      this.background_image.left = Math.floor(this.canvas.getWidth() / 2 + (-this.background_image.width * this.options.bgscale / 2 + this.centerX) * this.scale);
      this.background_image.top = Math.floor(this.canvas.getHeight() / 2 + (-this.background_image.height * this.options.bgscale / 2 + this.centerY) * this.scale);
      this.background_image.width = Math.floor(this.background_image.width * this.options.bgscale * this.scale);
      this.background_image.height = Math.floor(this.background_image.height * this.options.bgscale * this.scale);
